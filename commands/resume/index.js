...
async function resumePlayback() {
    try {
        await axios.put('https://api.spotify.com/v1/me/player/play?device_id=9dce3b5d2e08a997a31cda125769586bb177a23c', null, {
            headers: {
    ...
    execute: async (bot, userstate, context, args) => {
        try {
            if (userstate.displayName === 'lellolidk') {
                ...
                return { text: 'FeelsOkayMan 👍 Song resumed.', reply: true };
            } else {
